  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 overflow-x-hidden flex flex-col relative w-full">
      ...
      <Helmet>
        ...
        <meta name="description" content="Delta Dev's is a software development agency based in Maharashtra providing custom software, mobile apps, and GST billing solutions." />
        <meta name="keywords" content="Software Development, Web Development, Mobile Apps, GST Billing Software, Maharashtra, Pune" />
        <meta property="og:title" content="Delta Dev's | Custom Software & Web Development" />
        <meta property="og:description" content="Elevating businesses with premium custom software, mobile apps, and robust GST billing solutions across Maharashtra." />
      ...
      >
        <Suspense fallback={<LoadingFallback />}>
          <Hero />
          <SectionReveal><TrustedBy /></SectionReveal>
          ...
          <SectionReveal><CostEstimator /></SectionReveal>
